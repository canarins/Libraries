...
void setup_parameters()
{
  ...
  //SSID_vector_default.push_back("Freebox-32242D");
  //PASS_vector_default.push_back("hbk4nqmt26q3xnftqzcvwh");

  //SSID_vector_default.push_back("Letmeknow");
  //PASS_vector_default.push_back("letmeknow75002");
